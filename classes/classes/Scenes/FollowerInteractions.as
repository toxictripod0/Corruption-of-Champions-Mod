...
public function amilyUrtaSex():void {
	...
	if (player.cor > (50 + player.corruptionTolerance()) && flags[kFLAGS.AMILY_WANG_LENGTH] > 0) outputText("  Privately, you note that it's bullshit; she's nothing <b>but</b> self-pity.", false);
	outputText("\n\n", false);
