...
//    && (KATHERINE_TRAINING & KBIT_TRAINING_TALK_EDRYN) == 0)
			...
			if ((cockFitIndex >= 0 && player.cockArea(cockFitIndex) >= 24) && (player.lowerBody == LowerBody.HOOFED || player.countCocksOfType(CockTypesEnum.HORSE) > 0 || player.isCorruptEnough(50) || player.statusEffectv1(StatusEffects.Edryn) > 0)) {
