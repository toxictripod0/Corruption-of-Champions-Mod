package classes.Scenes.Places.Bazaar 
{
	...
	public class BlackCock extends BazaarAbstractContent
	{
		...
		public function satyrTFs():void
		{
			...
			if (rand(3) == 0 && changes < changeLimit && player.lowerBody == LOWER_BODY_TYPE_CLOVEN_HOOFED && player.hornType == HORNS_GOAT && player.faceType != Face.HUMAN) {
		...
		public function rhinoTFs():void
		{
			...
			//Gain rhino horns
			//Tier 1
			if (rand(4) == 0 && changes < changeLimit && player.faceType == Face.RHINO && player.hornType != HORNS_RHINO) {
			...
			//Tier 2
			if (rand(4) == 0 && changes < changeLimit && player.faceType == Face.RHINO && player.hornType == HORNS_RHINO && player.horns == 1) {
		...
		public function echidnaTFs():void
		{
			...
			if (rand(3) == 0 && changes < changeLimit && player.eyeType == Eyes.FOUR_SPIDER_EYES || player.eyeType == Eyes.SPIDER) {
			...
			//Gain Echidna tongue
			if (rand(3) == 0 && changes < changeLimit && player.echidnaScore() >= 2 && player.tongueType != Tongue.ECHIDNA) {
				...
				player.tongueType = Tongue.ECHIDNA;
				changes++;
			}
			//Gain quill hair
