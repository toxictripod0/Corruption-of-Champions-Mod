...
private function eggySuggest():void {
	...
	//[Demon: 
		...
		//[Fox:
		else if ((player.foxScore() >= 4 || player.kitsuneScore() >= 4) && player.earType == EARS_FOX && player.tailType == Tail.FOX) {
