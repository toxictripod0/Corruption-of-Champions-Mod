package classes.Scenes.Places  {
	...
	public class TownRuins extends BaseContent {
		...
		private function dontExploreAmilyVillage():void { //[No]
			clearOutput();
			outputText(images.showImage("location-townruins-path"));
		...
		private function exploreAmilyVillage():void { //[Yes]
			clearOutput();
		...
		private function dismantleMainText(progress:int = 0, buildingDesc:String = ""):void { //Main text goes here
			var nails:int = 0;
			var wood:int = 0;
			var stones:int = 0;
