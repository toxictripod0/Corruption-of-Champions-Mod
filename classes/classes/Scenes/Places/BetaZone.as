...
package classes.Scenes.Places 
{
	...
	public class BetaZone extends BaseContent
	{
		...
		public function betaZoneEntry():void {
			...
			outputText("\n\nThe nearest object that catches your attention is a large sign. A bit further but still on your left is a camp consisting of a few tents. Occasionally, the purple-skinned horned creature steps out of a large tent for a breath of fresh debug-filled air. A group of armored demons of all genders, sizes and colors sit at a round wooden table, playing a game of cards well-known from the other smutty fantasy game."); 
