...
protected function hasRequiredItemsToBreakKelt() : Boolean {
	return player.hasItem(consumables.SUCMILK, 15) || (player.hasItem(consumables.SUCMILK, 10) && hasPinkEgg()) || (player.hasItem(consumables.P_S_MLK, 10) && hasPinkEgg()) || player.hasItem(consumables.P_S_MLK, 15);
}
...
private function resistKeltsBSBreakHimIntro():void {
	...
	if (flags[kFLAGS.KELT_BREAK_LEVEL] == 0) {
		...
		if (!hasRequiredItemsToBreakKelt()) {
