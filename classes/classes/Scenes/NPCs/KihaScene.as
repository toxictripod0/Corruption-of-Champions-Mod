...
private function kihaRapesMen():void {
	...
	if (player.isNaga() || player.tailType == TAIL_TYPE_LIZARD) outputText("\"<i>Heh, if you had half as much dexterity as you do impudence, I'd let you do this for me.  Fat chance of that,</i>\" she remarks off-handedly.  ");
	...
	//[Lizard/naga tail: 
	if (player.isNaga() || player.tailType == TAIL_TYPE_LIZARD) outputText(" while your tail curls around to find your own asshole.  The grip of the dragon's nethers so intense, you barely feel the pressure of your own tail, pushing in easily to soothingly stroke your overtaxed prostate");
...
private function victoryDickKiha():void {
	...
	if (player.lust > 60) outputText("only makes " + player.sMultiCockDesc() + " harder.");
	...
	if (y != -1 && player.cockTotal() > 1) {
		...
		if (player.isNaga() || player.tailType == TAIL_TYPE_LIZARD || z >= 0) outputText(" gasping mouth,");
...
private function kihaRapesLittleGirlsISawItOnTheNews():void {
	...
	outputText("\"<i>Here's how this is going to go,</i>\" she murmurs when you've finally stopped gasping for breath.  \"<i>You will lick me until I tell you to stop, and every time you displease me I'm going to take it out on your sensitive little fuck hole.</i>\"  She swings around and sits on your face, smashing her wet cunt on your " + player.face() + ".  \"<i>Be grateful that I'm letting you do this,</i>\" she gurgles, pinching your clit again for emphasis.  Doing as you're told, you lick deeply into the warm velvet of the dragon's folds.");
	if (player.tongueType == TONGUE_SNAKE) outputText("  You are grateful for your forked tongue, which allows you to cover more of her pussy at once.");
