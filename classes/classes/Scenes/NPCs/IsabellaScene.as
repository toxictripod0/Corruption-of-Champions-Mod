...
public function nomOnMommaIzzysTits():void {
	...
	if (player.tallness > 78 || player.isTaur()) {
		...
		if (player.wingType > WING_TYPE_NONE && player.wingType != WING_TYPE_SHARK_FIN) outputText(" and stroke your wings");
...
public function tooBigVictoryTittyFuckingFuntimesWithMilk():void {
	...
	if (player.lust > 70) outputText("pulsate with your raging lust");
