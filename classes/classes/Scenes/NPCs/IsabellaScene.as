...
public function nomOnMommaIzzysTits():void {
	...
	if (player.tallness > 78 || player.isTaur()) {
		...
		if (player.horns > 0 && player.hornType > Horns.NONE) outputText("your horns");
		...
		if (player.wingType != Wings.NONE) outputText(" and stroke your wings");
...
public function volunteerToSlurpCowCunt():void {
	...
	else outputText("Unabashedly, you dive right into the cow-girl's lust-slicked snatch.  Her greedy lips swallow your nose and lips with one wet squelch, but the cow-girl doesn't seem quite satisfied until her hand is on the back of your head, mashing your " + player.face() + " roughly over her sex.");
...
public function IsabellaPostSpankFeedSex():void {
	...
	if (player.tongueType == Tongue.HUMAN) outputText("smaller");
