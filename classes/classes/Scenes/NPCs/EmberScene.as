...
//Player always gets the egg.
		private function emberIsAnEggFactory():void
		{
			...
			//(High Affection)
				...
				if (player.tongueType > Tongue.HUMAN) outputText(" and out... and out...");
				...
				if (player.tongueType > Tongue.HUMAN) outputText("which is quite far indeed, ");
				...
				if (player.tongueType > Tongue.HUMAN) outputText("  Right at this time, you feel something round and smooth on the tip of your tongue, gently spreading Ember's walls.  Realizing that this can only be her egg, you start trying to worm your long, sinuous tongue between it and her innermost walls, hoping to coax it out of her.");
...
//Eat Ember Out - b-baka! (Z)
		private function slurpDraggieCunnies():void
		{
			...
			if (player.tongueType > Tongue.HUMAN) outputText("inhuman ");
...
//Get Penetrated - also horse-proof, sorry folks! (Z)
		private function getPenetratedByEmberLastSexSceneWoooo():void
		{
			...
			if (player.tongueType == Tongue.HUMAN) outputText("yours ");
...
//Penetrate:
		private function penetrateWithEmber(clear:Boolean = true):void
		{
			...
			if (player.wingType > Wings.NONE) outputText("stopping momentarily to stroke along your [wings] before continuing up and ");
