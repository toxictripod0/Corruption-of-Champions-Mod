...
//const GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER:int = 510;
		...
		public function timeChangeLarge():Boolean {
			...
			if (flags[kFLAGS.SHOULDRA_PALADIN_MAIDEN_COUNTDOWN] > 0) {
				if (player.cockTotal() > 1 || player.faceType != Face.HUMAN || player.lowerBody != LOWER_BODY_TYPE_HUMAN || player.tailType > Tail.NONE || player.horns > 0 || !player.isPureEnough(15) || player.longestCockLength() > 10 || player.tallness < 65 || player.tallness > 78 || player.hasVagina())
