package classes.Scenes.NPCs.pregnancies
{
	...
	public class PlayerMarblePregnancy implements VaginalPregnancy
	{
		...
		public function PlayerMarblePregnancy(pregnancyProgression:PregnancyProgression, output:GuiOutput)
		{
			this.output = output;
		...
		public function updateVaginalPregnancy():Boolean
		{
			...
			if (player.pregnancyIncubation === 72) {
				...
				if (player.cor >= 75) output.text("and you're eager to give birth, so you can get fill your womb with a new charge.</b>");
				output.text("\n");
		...
		public function vaginalBirth():void
		{
			...
			if (kGAMECLASS.prison.prisonLetter.deliverChildWhileInPrison()) return;
