...
//			doNext(5025); // Find out the gameover shits
		...
		public function deerTFs():void
		{
			...
			//Gain deer tail
			if (rand(3) == 0 && changes < changeLimit && player.earType == EARS_DEER && player.tailType != Tail.DEER) {
			...
			if (rand(3) == 0 && changes < changeLimit && player.earType == EARS_DEER && (player.faceType != Face.HUMAN && player.faceType != Face.DEER)) {
			...
			//Gain deer face
			if (rand(4) == 0 && changes < changeLimit && player.hasFur() && player.earType == EARS_DEER && player.tailType == Tail.DEER && player.faceType != Face.DEER) {
			...
			if (rand(4) == 0 && changes < changeLimit && player.earType == EARS_DEER && player.tailType == Tail.DEER && player.hasFur() && player.lowerBody != LOWER_BODY_TYPE_CLOVEN_HOOFED) {
