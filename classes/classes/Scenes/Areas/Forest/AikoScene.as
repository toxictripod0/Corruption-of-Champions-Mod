package classes.Scenes.Areas.Forest
{
	...
	public function encounterChance():Number { return 0.2; }
	...
	private function aikoApologize1():void
	{
		...
		if (player.isCorruptEnough(33))
			addButton(1, "Trick Her", aikoApologyTrick).hint("Nope, just another trick to get close!");
		else
			addDisabledButton(1, "Trick Her").hint("Nope, just another trick to get close!\n<b>You are not corrupt enough</b>");
	}
	...
	public function pcLosesDomFight():void
	{
		...
		if (player.hasStatusEffect(StatusEffects.DomFight))
			player.removeStatusEffect(StatusEffects.DomFight);
		if (flags[kFLAGS.AIKO_CORRUPTION] < 50 && flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] > 0) {
			var x:int = rand(player.cocks.length)+1;
			...
			+(player.hasCock()?"As your vision darkens once more, you can feel the heat of Aiko’s sopping cunt against the tip of your [cock "+x+"], teasing you with their slick depths. The soft, warm lips dilate tantalizingly around your head, and with an abrupt drop, she mounts your member, squeezing down tightly!\n\n":"")
	...
	public function aikoRapeSex():void {
		...
		menu();
		if (player.hasCock()) {			
			addButton(0, "Fuck Vag", aikoRapeFuckVag).hint("Pound ze foxy pussy!");
			if (player.cockThatFits(50) > 0)
				addButton(1, "Fuck Ass", aikoRapeFuckAss).hint("Get some of that tight, juicy ass!");
			else 
				addDisabledButton(1, "Fuck Ass").hint("Get some of that tight, juicy ass!\nGet a smaller dick for this");
		} else {
			addDisabledButton(0, "Fuck Vag").hint("Pound ze foxy pussy!\nYou need a dick for this.");
			addDisabledButton(1, "Fuck Ass").hint("Get some of that tight, juicy ass!\n\nYou need a dick for this");
		}
		...
		if (flags[kFLAGS.AIKO_BALL_RETURNED] == 1) {
			...
			if (player.hasVagina())
				addButton(4, "Get Licked", aikoRapeGetLicked).hint("This time you want Aiko to eat you out!");
			else
				addDisabledButton(4, "Get Licked").hint("This time you want Aiko to eat you out!\nRequires a vagina");
		}
		if (flags[kFLAGS.AIKO_BALL_RETURNED] != 1)
	...
	private function aikoRapeFuckVag():void
	{
		...
		+"You place the tip of your [cock "+x+"] against her quivering snatch, bearing down on her just a bit. Her moist love-hole is tight, but yields to you with relative ease. You let out a moan as you sink into her little by little, her soft, muscular walls wrapping around you and enveloping you with an almost ethereal warmth. [if (player.cocks["+x+"].length >= 40) Just when you are certain that she should be unable to take any more of your enormous manhood, a slurping contraction draws you even deeper.] "
		+(player.hasKnot(x)?"When you feel your knot pushing against her lips, you shift your weight to lean over her and begin to pound her pussy with your [cock "+x+"].":"When you feel your hips rocking against hers, you shift your weight to lean over her and begin to pound her pussy with your [cock "+x+"].")
	...
	private function aikoRapeFuckAss():void
	{
		...
		+"The large spiral-shaped tattoos adorning her ass seem to be the perfect place for you to grab hold of both cheeks as you run your [c] along her slit, getting coated in her slick juices in preparation. She lets out a soft whimper as she feels you push your [cock "+x+"] flush against her pucker, lowering her shoulders toward the ground and gripping the dirt.\n\n"
		+"<i>“Please be gentle…”</i> she says as the tight ring of flesh begins to expand around your tip. Her face turns a deep crimson as you sink the first inch inside her, squeezing her ample cheeks around your [cock"+x+"] and moaning needily.\n\n"
	...
	private function aikoRapeHumiliate():void
	{
		...
		if (player.hasCock()) {
			...
			if (!player.hasVagina())
				...
				outputText("You raise your hips and angle your [cock "+x+"] toward her mouth, pressing the head against her tightly pursed lips. Reaching down, you pinch her nose tightly, forcing her to open her mouth lest she suffocate, and she reluctantly begins swallow your mass[if (player.cocks["+x+"].cockThickness >= 3), gagging on your girth].\n\n"
	...
	private function aikoSexMissionary():void
	{
		...
		+"Her walls give one final muscular contraction, clamping down on your [cock "+x+"] with unbelievable tightness and pulling you in with an incredible suction. "
	...
	private function aikoSexDoggy():void
	{
		clearOutput();
		spriteSelect(SpriteDb.s_aiko);
		var y:int = player.cockThatFits(50, "area")+1;
		var x:int = rand(player.cocks.length)+1;
		...
		+"\n\nYou strip out of your [armor] eagerly, smiling as the lovely kitsune lowers herself down to the ground, reaching up to take hold of your [multicock]. Her hands begin to stroke and knead, and your shaft[if (player.cocks.length>1)s] soon grow[if (player.cocks.length==1)s] hard under her skillful technique. She gives the tip of your [cock "+x+"] a playful lick, and then changes position, moving down to her hands and knees in front of you with her luscious ass raised high in the air, tails fanned out like a peacock.\n\n"
		+"With a grin, you lower yourself down, placing your palms on the exotic spiral tattoos that adorn her heavy, jiggling butt cheeks and positioning yourself behind her. The tip of your [cock "+x+"] gently brushes up against her lady lips, and you can feel a veritable fountain of juices spilling out over it. You can see Aiko blush in embarrassment from how wet she is already, but she quickly deflects your attention back to her loins as she backs up onto your shaft a few inches, letting out a lewd moan.\n\n"
		...
		+(y != 0 ?"While you passionately fuck her pussy, your [cock "+y+"] slides between her buttocks, significantly lubed up by the seemingly never-ending gush of fluids. Whenever you take a particularly long draw, it occasionally presses up against her pursed anus for a moment before moving along. Aiko looks back at you with a deep blush on her face and says, <i>“NN… ah! You can… Ooh! … If…. youuuUAuuh… want… F-fuck… my… a-ass, I m-meeeeeaAAhhn….”</i>"+"With her permission, you draw back and press up against her tight pucker, leaning forward to pierce her ass with your [cock "+y+"]! Aiko lets out a deep moan, wincing a little at first, but her warm innards are quite receptive to your shaft and her pain turns into pleasure within moments. Her anus begins to squeeze and suckle on you with every stroke, and the dual sensations of her two holes drives you mad with pleasure.":"")
		+"Impaled on your shaft[if ("+y+" != 0)s], Aiko starts to buck back on you with redoubled passion, pressing her cheek into the grass as she continues to flick and squeeze her clitoris."
		...
		+"She cums HARD, and the effects are immediate and intense—her pussy [if ("+y+" != 0)and asshole] squeeze[if ("+y+" == 0)s] down on your cock[if ("+y+" != 0)s], and the heat inside her becomes almost unbearably pleasurable. You can’t hold back any longer, and have no reason to, squeezing her hips and thrusting inside with one final moan as you release your load inside her.\n\n"
		+(player.cumQ() > 350 ? "Her hole[if ("+y+" != 0)s] gurgle[if ("+y+" == 0)s] audibly as you pump your virile baby cream into [if ("+y+" != 0)both] her fuckhole[if ("+y+" != 0)s], feeling her abdomen start to swell up. She looks heavily pregnant by the time you finish dumping your load into her, letting her tongue loll out in pure bliss.\n\n":"")
		+(flags[kFLAGS.AIKO_AFFECTION] >= 50 ?"<i>“Th-that… was great…”</i> she says, falling forward "+(player.hasKnot(x)||player.hasKnot(y)?"and dragging you with her by your knotted cock before turning onto her side on the grass, both of you panting tiredly.\n\n":"off your cock[if ("+y+" != 0)s] to lay on her side on the grass. You follow soon after her, flopping down beside her with your arms splayed out tiredly, you both panting softly.\n\n")+
		(flags[kFLAGS.AIKO_AFFECTION] >= 65?(player.hasKnot(x)||player.hasKnot(y)?"She wiggles her ass tighter into you, still linked tightly by your knot":"She curls up against you")+", all seven of her tails wrapping around you like a large blanket, and presses her "+(player.hasKnot(x)||player.hasKnot(y)?"nose":"head")+" into your shoulder sweetly, closing her eyes. The two of you cuddle together on the grass for the remainder of the hour, but you finally have to tell her you need to go back to camp. "+(player.hasKnot(x)||player.hasKnot(y)?"You pull out of her, your knot having finally deflated and stand up. ":"")+"She waves goodbye, curling up underneath the tree and wrapping her tails around herself with a warm smile on her face.\n\n":
		(player.hasKnot(x)||player.hasKnot(y)?"You pull out of her, your knot having finally deflated and stand up. ":"You sit up slowly,")+" and tell Aiko that you should be heading back to camp soon. She nods in understanding, and then sighs a bit, curling up under the tree and wrapping her tails around herself.\n\n"):
	...
	private function aikoSexBJ():void
	{
		...
		+"\n\nShe smirks as your [cocks] bob[if (player.cocks.length==1)s] up into view, looking up to you with a mischievous smirk as she wraps her fingers around your [cock "+x+"], beginning to stroke it gently. <i>“Mmm… you’re already so hard,”</i> she says, gently rubbing her cheek into your groin, moving her nose to the base of your [cocks] and taking in your scent.\n\n"
		+"She purses her lips against your base, sucking on the side of your shaft gently as her palm wraps around the head, squeezing drops of pre out and using them to lubricate her hand as she lavishes your [cocks] with passionate kisses and strokes. She pulls her hand away for a moment, summoning a pale blue flame into her palm, and returns it to your main shaft, coating it with cool wisps of fire that send shudders up your spine. [if (player.balls > 0)Her other hand gently lifts your [balls], squeezing them softly as she runs her tongue up the underside of your [cock "+x+"].]\n\n");
		if (player.cockArea(x) < 40) {
			outputText("Her lips smack loudly as she plants kisses up and down your shaft, sending your senses into a frenzy as her hand works its way up and down your [cock "+x+"], dragging her fingertips along the length. [if (player.balls > 0)Cupping your [balls],] Aiko gently glides her tongue up the underside of your shaft one last time, opening her lips into a wide O and engulfing you in her warm, moist mouth.\n\n"
			+"Keeping one hand wrapped tightly around the base, she begins to bob her head forward and back, letting your [cock "+x+"] hit the back of her throat with each gentle thrust. Her crystal blue eyes stare up at you coyly as she does so, her mouth curled into a smile around your quivering manhood. Pressing you against the back of her mouth, she swallows several times, the gentle rippling of her throat muscles massaging the head of your [cock "+x+"].\n\n"
			...
			+"Letting out an obscene moan, you lose yourself in pleasure as your [cock "+x+"] shoots hot ropes of semen into Aiko’s mouth, coating her throat with your virile jizz. She moans, closing her eyes, and presses her lips to the base of your shaft, her throat contracting rhythmically as she endeavors to swallow your load. "+(player.cumQ() >150 ?"She puts up a good effort, but ultimately fails as jets of cum spurt from the corners of her mouth"+(player.cumQ() >350 ?". As more and more of your semen cascades down her throat, her stomach begins to bulge a little bit, though far more of it gets on her than in her as it oozes messily down her chin":""):"")
			...
			+".\n\nOnce your orgasm is finished, she locks her mouth tightly around your deflating shaft and pulls back, squeezing the last bits of cum from your urethra and leaving your [cock "+x+"] clean as a whistle as her lips leave it with a soft smack. Using the corner of one of her sleeves, she cleans the remainder of your cum off her face, and then lets out a cute burp, patting her chest and saying <i>“Mn, oh, excuse me.</i>");
		} else {
			...
			+"Letting out an obscene moan, you lose yourself in pleasure as your [cock "+x+"] shoots out hot ropes of semen all over Aiko’s face and chest, twitching like mad. Stream after stream spills out, several orgasms’ worth of cum finally allowed to fly free, making a thick, warm mess all over her face and breasts. "+(player.cumQ() >350 ?"Your orgasm seems to go on forever, and by the time it is all over, Aiko’s face is almost unrecognizable, hidden under a sticky mask of your cum.":"")+"\n\n"
			+"[if (player.cocks.length>1) the rest of your [cocks] spilling their spunk all over Aiko's chest and the ground below you][if (player.hasVagina()), and your vagina spasming, dripping your excretions down the sides of your thighs and onto the ground, forming a messy puddle of combined sexual fluids]"
	...
	private function aikoSexTailjob():void
	{
		...
		spriteSelect(SpriteDb.s_aiko);
		var x:int = rand(player.cocks.length)+1;
		outputText((playerchoice?"You ask Aiko if she can use her tails this time as you seductively let your [armor] slide off your body, exposing to the skittish kitsune your [cock "+x+"]. She instantly blushes and lowers her ears, aww.\n\n"
		...
		+"As the kitsune continues to torment your rod, you notice that a second tail has joined the action, encircling the tip of your [cock "+x+"] while the other one firmly remains wrapped around the base[if (player.balls > 0), caressing your balls]. "
	...
	private function aikoFootjob():void
	{
		...
		+"<i>“Heheh… you’re such a pathetic loser, getting off on something this.... You’re just a twisted perv, aren’t you?”,/i> she says with a grin, leaning down closer so that she can put more pressure on your groin. As her foot slides back and forth along the length of your [cock "+x+"], she begins to drag her nails along your chest and shoulders, eliciting a moan of pain and pleasure from your throat. <i>“Isn’t that right? You can talk a big game but you’re just a big masochist who gets off on having your dick rubbed up against my foot!”</i>\n\n"
		...
		if (rand(4)==0) {
			...
			outputText("<i>“That’s a good little masochist…”</i> she says quietly, wrapping [if(player.cocks.length==1)one of] her free tails around the base[if(player.cocks.length>1)s] of your [cocks] and constricting tightly like [if(player.cocks.length==1)a ]fluffy cock ring[if(player.cocks.length>1)s], increasing the speed of her rough stroking. Her toes curl around your [cock "+x+"], her foot becoming a blur as it vibrates across your [cock "+x+"] with a furious speed that would chafe if not for the copious amounts of lubrication acting as a buffer. The base[if(player.cocks.length>1)s] of your [cocks]distends as more and more cum pools into your shaft[if(player.cocks.length>1)s] below the tight grip of her tail[if(player.cocks.length>1)s].\n\n"
			+"Your [cocks] twitch[if(player.cocks.length==1)es] in vain as you feel load after load backing up inside you. Aiko laughs at your suffering, sliding her foot down to the base of your [cock "+x+"] and experimentally prodding at the swollen flesh. The feeling sends a shock of pleasure up your spine, and you begin to beg her to end this torment and let you cum!\n\n"
	...
	private function yamataIntro():void
	{
		...
		+"<i>“Well, well, look who we have here...”</i>\n\n" //look who the cat dragged in!
