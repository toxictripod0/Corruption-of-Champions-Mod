...
package classes.Scenes.Areas.Forest
{
	...
	public class BeeGirlScene extends BaseContent
	{
		...
		private function beeEncounterClassicSex(postCombat:Boolean = true):void {
			...
			//non-dicked version
				...
				//Coochie talk!
					...
					if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_WET)outputText("centering around your now puffy vulva.  ");
					if (player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_WET && player.vaginas[0].vaginalWetness < VAGINA_WETNESS_DROOLING)outputText("growing more potent around your " + player.vaginaDescript(0) + " as it begins to leak with the honey of your desire.  ");
					if (player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING) outputText("inflaming your " + player.vaginaDescript(0) + " with need, and allowing a river of your wetness to gush from between your puffy vulva.  ");
				}
				//Boobies!
				if (player.biggestTitSize() > 1) {
		...
		private function beeDroneBadEnd():void {
			...
			if (player.wingType == Wings.TYPE_BEE_LIKE_LARGE) {
				...
				else if (player.wingType == Wings.TYPE_BEE_LIKE_SMALL) {
...
//FEMALE sometimes herm
		private function rapeABeeGirlWithYourVagina():void
		{
			...
			if (player.isTaur()) {
				...
				if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLICK) outputText("Thankfully her tongue keeps up its assault, curling 'round your clit and probing your depths in equal measure, keeping you slick and writhing in pleasure.  ");
...
//FUTA Fallback
		private function futaRapesBeeGirl():void
		{
			...
			if (player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_NORMAL) outputText("Your " + player.vaginaDescript(0) + " becomes puffy and moist with excitement, ready for what you have planned.");
			if (player.vaginas[0].vaginalWetness > VAGINA_WETNESS_NORMAL && player.vaginas[0].vaginalWetness < VAGINA_WETNESS_DROOLING) outputText("Your " + player.vaginaDescript(0) + " squicks wetly from your gentle ministrations as your vulva become sensitive and engorged.");
			if (player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING) outputText("Your " + player.vaginaDescript(0) + " gushes in response, dripping steadily over your victim's face, covering it with a spattering of girl-cum.");
			//New PG
...
//Naga on Bee Scene
		...
		private function nagaRapesPt2TheExtremeContinuationOfAwesome():void
		{
			...
			//[Player is female]
				...
				if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_WET) outputText("Damp");
				else if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_DROOLING) outputText("Wet");
				else if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLAVERING) outputText("Dripping");
				...
				if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLICK) outputText("A few drops ");
				else if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_DROOLING) outputText("A gush ");
				else if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLAVERING) outputText("Wave after wave ");
