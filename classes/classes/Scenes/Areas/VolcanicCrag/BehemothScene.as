package classes.Scenes.Areas.VolcanicCrag 
{
	...
	public class BehemothScene extends BaseContent
	{
		...
		private function talkAboutHisChildren():void {
			...
			outputText("\n\nYou play with your lover and offspring for a while, then heead back to camp.");
		...
		private function haveACumBathLiterally():void {
			...
			outputText("\n\nYou" + player.clothedOrNaked(player.armor == armors.GOOARMR ? "Valeria pours away from you" : "You remove your [armor], put it into a neat pile on his bed and ") + (player.isGoo() || player.isNaga() ? "slither": "walk") + " over to the basin. \"<i>This is where I cum in,</i>\" he puns terribly, gesturing to the tub, and you get in as he lifts aside his loincloth.");
