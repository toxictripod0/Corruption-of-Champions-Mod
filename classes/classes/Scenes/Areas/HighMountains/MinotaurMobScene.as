...
private function forceMinitaurToGiveOral(choice:Number = 0):void {
	...
	if (choice == 0) {
		...
		//Picture is here
		outputText(images.showImage("minomob-oral"));
		...
		outputText("You begin to undulate your " + player.hipDescript() + " into the minitaur's bestial muzzle, grinding and groaning in joy at the forced cunnilingus.  ");
...
private function minotaurGangBadEnd():void {
	...
	//Picture is here
	outputText(images.showImage("minomob-minitaur"));
...
private function minotaurGangBadEnd2():void {
	...
	//Picture is here
	outputText(images.showImage("badend-minomob"));
