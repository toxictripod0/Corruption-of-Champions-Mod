...
private function AddictNagaOnMinotaur():void {
	...
	//Picture is here
	outputText(images.showImage("minotaur-win-naga"));
...
private function girlRapeAMinotaur():void {
	...
	//Too big
	if (player.vaginalCapacity() *1.5 >= monster.cockArea(0)) outputText("Every stroke of his " + monster.cockDescriptShort(0) + " slides easily into your " + player.vaginaDescript(0) + ", allowing him to slowly build up a puddle of his wondrous druggy pre-seed into your aching womb.  ");
	//Resume!
...
private function minotaurGetsRapedByHerms():void {
	...
	player.slimeFeed();
	//Picture is here
	outputText(images.showImage("minotaur-win-herm"));
	...
	if (player.vaginas[0].vaginalLooseness >= VaginaClass.LOOSENESS_GAPING) outputText("The intense feelings seem to grow more and more powerful as he stays inside you, his drug-like pre-cum making your " + player.vaginaDescript(0) + " tingle from the inside-out.");
...
public function getRapedByMinotaur(autoRape:Boolean = false):void {
	...
	if (player.vaginas.length > 0) {
		//Picture is here
		outputText(images.showImage("minotaur-loss-vag"));
...
private function getOralRapedByMinotaur():void {
	...
	//Picture is here
	outputText(images.showImage("minotaur-loss-oral"));
	//new pg
...
private function minoGetsTitFucked():void {
	...
	outputText("\n\n");//Picture is here
	outputText(images.showImage("minotaur-win-titfuck"));
...
private function minoCumAddictBadEnd3():void {
	...
	//Picture is here
	outputText(images.showImage("badend-minotaur"));
	getGame().gameOver();
...
private function minotaurDrinksMilkNewsAtEleven():void {
	...
	clearOutput();
	//Picture is here
	outputText(images.showImage("minotaur-win-breastfeeding"));
...
private function minotaurBlowjob():void {
	...
	//Picture is here
	outputText(images.showImage("minotaur-cocksucker"));
