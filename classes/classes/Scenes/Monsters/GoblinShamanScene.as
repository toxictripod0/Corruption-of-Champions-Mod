package classes.Scenes.Monsters
{
	...
	public class GoblinShamanScene extends BaseContent
	{
		...
		public function goblinShamanBeatYaUp():void {
			...
			if (doSFWloss()) return;
			var x:int;
			if (player.lust100 <= 99) outputText("You collapse, utterly beaten. To make sure you'll be easier to handle, the victorious shaman saunters up, pink arousing flames glow in her left hand. She exposes your nether regions and throws the pink flames right into your groin! You are unable to fight back. \n\n");
