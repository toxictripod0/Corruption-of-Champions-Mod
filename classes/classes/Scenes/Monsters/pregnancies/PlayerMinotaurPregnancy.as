	...
	public class PlayerMinotaurPregnancy implements VaginalPregnancy
	{
		...
		public function updateVaginalPregnancy():Boolean 
		{
			...
			var displayedUpdate:Boolean = false;
				...
				if (player.pregnancyIncubation === 48) {
					...
					if (player.cor >= 75) output.text("You find yourself daydreaming about birthing some huge monstrous beast, and raising it to fuck your wet pussy over and over.</b>\n");
				}
		...
		public function vaginalBirth():void 
		{
			...
			var player:Player = kGAMECLASS.player;
				...
				if (kGAMECLASS.flags[kFLAGS.MINOTAUR_SONS_GROWUP_COUNTER] === 0) kGAMECLASS.flags[kFLAGS.MINOTAUR_SONS_GROWUP_COUNTER] = 150;	
		}
	}
}
