package classes.Scenes.Monsters.pregnancies 
{
	...
	public class PlayerSpiderPregnancy implements VaginalPregnancy
	{
		 ...
		 */
		public function PlayerSpiderPregnancy(pregnancyProgression:PregnancyProgression, output:GuiOutput) 
		{
		...
		public function updateVaginalPregnancy():Boolean 
		{
			...
			if (player.pregnancyIncubation === 180) {
				...
				if (player.pregnancyType === PregnancyStore.PREGNANCY_SPIDER) output.text("spider-morphs ");
				else output.text("driders ");
