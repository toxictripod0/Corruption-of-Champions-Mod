package classes.Scenes.Seasonal {
	...
	public class Valentines extends BaseContent 
	{
		...
		public function pleasureAbbyVDay():void {
			...
			//([Naga tongue]
			if (player.tongueType == Tongue.SNAKE) outputText("  Your fingers make it into her pussy alongside your tongue, and the prehensile thing, longer and more flexible than a human's, ravages the insides of her pussy, tasting everywhere as Abby shakes in her orgasm.  Her pussy eagerly tries to milk both your fingers and your tongue, clenching and gripping at them as it drips her pussy juices all over your face.  Abby screams out in a loud, uninhibited orgasm at last, expressing her ecstasy.");
			//([Demon/Dragon Tongue]
