package classes.Items 
{
	...
	public final class UndergarmentLib 
	{
		...
		public const EBNCRST:Undergarment = new Undergarment("EW Corset", "EW Corset", "Ebonweave corset", "an Ebonweave corset", TYPE_UPPERWEAR, 900, "This corset is made of ebonweave, created using refined Ebonbloom petals. The ebonweave is elastic, making the corset surprisingly comfortable to wear, while displaying your bust down to the most subtle curves.");
		...
		public const EBNJOCK:Undergarment = new Undergarment("EbonStrap", "EbonStrap", "Ebonweave jockstrap", "an Ebonweave jockstrap", TYPE_LOWERWEAR, 900, "This jock is ebonweave, made of refined Ebonbloom petals. It’s comfortable and elastic, providing support while containing assets of any size.");
		public const EBNTHNG:Undergarment = new Undergarment("EbonThong", "EbonThong", "Ebonweave thong", "an Ebonweave thong", TYPE_LOWERWEAR, 900, "This thong is made of ebonweave, designed to fit snugly around your form. Thanks to alchemic treatments, it’s elastic enough to hold assets of any size.");
		public const EBNCLTH:Undergarment = new Undergarment("EbonCloth", "EbonCloth", "Ebonweave loincloth", "an Ebonweave loincloth", TYPE_LOWERWEAR, 900, "This loincloth is made of ebonweave, designed to fit snugly around your form. Thanks to alchemic treatments, it’s elastic enough to hold assets of any size.", "NagaWearable");
		public const EBNRJCK:Undergarment = new UndergarmentWithPerk("RuneStrap", "RuneStrap", "runed Ebonweave jockstrap", "a runed Ebonweave jockstrap", TYPE_LOWERWEAR, 1200, "This jock is ebonweave, made of refined Ebonbloom petals. Adorning the pouch is a rune of lust, glowing with dark magic.",
		...
		public const EBNRTNG:Undergarment = new UndergarmentWithPerk("RuneThong", "RuneThong", "runed Ebonweave thong", "a runed Ebonweave thong", TYPE_LOWERWEAR, 1200, "This thong is made of ebonweave, designed to fit snugly around your form. Adorning the front is a rune of lust, glowing with dark magic.",
				PerkLib.WellspringOfLust,0,0,0,0,"At the beginning of combat, lust raises to black magic threshold if lust is below black magic threshold.");
		public const EBNRLNC:Undergarment = new UndergarmentWithPerk("RuneCloth", "RuneCloth", "runed Ebonweave loincloth", "a runed Ebonweave loincloth", TYPE_LOWERWEAR, 1200, "This loincloth is made of ebonweave, designed to fit snugly around your form. Adorning the front is a rune of lust, glowing with dark magic.",
