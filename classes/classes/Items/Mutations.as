		...
		public function wolfPepper(player:Player):void {
			...
			if (changes < changeLimit && rand(3) == 0 && player.eyeType != EYES_HUMAN && player.eyeType != EYES_WOLF) {
				if (player.eyeType == EYES_BLACK_EYES_SAND_TRAP) {
					...
					outputText("\n\nYou blink and stumble, a wave of vertigo threatening to pull your " + player.feet() + " from under you. As you steady and open your eyes, you realize something seems different. Your vision is changed somehow.", false);
					if (player.eyeType == EYES_FOUR_SPIDER_EYES) outputText(" Your multiple, arachnid eyes are gone!", false);
			...
			if (player.hairType != HAIR_NORMAL && changes < changeLimit && rand(3) == 0) {
				outputText("\n\nYou reach up and feel the top of your head as it begins to tingle. You put a hand on the top of your head and slowly pull it down. Chunks of your " + player.hairDescript() + " come with, replaced by a set of normal, human hair.", false);
