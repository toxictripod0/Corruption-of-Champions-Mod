package classes.Items.Consumables 
{
	...
	public class WhiskerFruit extends Consumable 
	{
		...
		override public function useItem():Boolean
		{
			...
			if (player.tailType === Tail.CAT && player.earType === EARS_CAT && rand(5) === 0 && changes < changeLimit && player.lowerBody === LOWER_BODY_TYPE_CAT && (player.hasFur() || (player.hasReptileScales() && player.dragonneScore() >= 4)) && player.faceType !== Face.CAT) {
