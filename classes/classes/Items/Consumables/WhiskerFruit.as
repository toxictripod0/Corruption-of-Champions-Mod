package classes.Items.Consumables 
{
	...
	public class WhiskerFruit extends Consumable 
	{
		...
		override public function useItem():Boolean
		{
			...
			//Cat dangly-doo.
			if (player.cockTotal() > 0 && player.countCocksOfType(CockTypesEnum.CAT) < player.cockTotal() && (player.ears.type === Ears.CAT || rand(3) > 0) && (player.tailType === Tail.CAT || rand(3) > 0) && changes < changeLimit && rand(4) === 0) {
			...
			if (player.tailType !== Tail.CAT && player.ears.type === Ears.CAT && rand(5) === 0 && changes < changeLimit) {
			...
			if (player.tailType === Tail.CAT && player.ears.type === Ears.CAT && rand(5) === 0 && changes < changeLimit && player.lowerBody.type !== LowerBody.CAT) {
				//hoof to cat:
			...
			if (player.tailType === Tail.CAT && player.ears.type === Ears.CAT && rand(5) === 0 && changes < changeLimit && player.lowerBody.type === LowerBody.CAT && !player.hasFur()) {
			...
			if (player.tailType === Tail.CAT && player.ears.type === Ears.CAT && rand(5) === 0 && changes < changeLimit && player.lowerBody.type === LowerBody.CAT && (player.hasFur() || (player.hasReptileScales() && player.dragonneScore() >= 4)) && player.face.type !== Face.CAT) {
