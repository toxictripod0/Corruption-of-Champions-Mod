package classes.Items.Consumables 
{
	...
	public class Reptilum extends Consumable 
	{
		...
		override public function useItem():Boolean
		{
			...
			//Gain predator arms
			if (player.armType !== Arms.PREDATOR && player.hasReptileScales() && player.lowerBody === LOWER_BODY_TYPE_LIZARD && changes < changeLimit && rand(3) === 0) {
			...
			//Claw transition
			if (player.armType === Arms.PREDATOR && player.hasLizardScales() && player.clawType !== CLAW_TYPE_LIZARD && changes < changeLimit && rand(3) === 0) {
			...
			if (player.tailType !== Tail.LIZARD && player.lowerBody === LOWER_BODY_TYPE_LIZARD && changes < changeLimit && rand(5) === 0) {
				//No tail
			...
			if (player.earType !== EARS_LIZARD && player.tailType === Tail.LIZARD && player.lowerBody === LOWER_BODY_TYPE_LIZARD && changes < changeLimit && rand(5) === 0) {
			...
			if (!player.hasLizardScales() && player.earType === EARS_LIZARD && player.tailType === Tail.LIZARD && player.lowerBody === LOWER_BODY_TYPE_LIZARD && changes < changeLimit && rand(5) === 0) {
				//(fur)
			...
			//-Lizard-like face.
			if (player.faceType !== Face.LIZARD && player.hasReptileScales() && player.earType === EARS_LIZARD && player.tailType === Tail.LIZARD && player.lowerBody === LOWER_BODY_TYPE_LIZARD && changes < changeLimit && rand(5) === 0) {
			...
			//-Lizard eyes
			if (!player.hasLizardEyes() && player.faceType === Face.LIZARD && player.hasReptileScales() && player.earType === EARS_LIZARD && changes < changeLimit && rand(4) === 0) {
