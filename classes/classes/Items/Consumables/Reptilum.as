package classes.Items.Consumables 
{
	...
	public class Reptilum extends Consumable 
	{
		...
		override public function useItem():Boolean
		{
			...
			if (player.earType !== Ears.LIZARD && player.tailType === Tail.LIZARD && player.lowerBody === LOWER_BODY_TYPE_LIZARD && changes < changeLimit && rand(5) === 0) {
			...
			if (!player.hasLizardScales() && player.earType === Ears.LIZARD && player.tailType === Tail.LIZARD && player.lowerBody === LOWER_BODY_TYPE_LIZARD && changes < changeLimit && rand(5) === 0) {
				//(fur)
