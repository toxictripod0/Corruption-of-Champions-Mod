package classes.Items.Consumables
{
	...
	public class Clovis extends Consumable
	{
		...
		override public function useItem():Boolean
		{
			...
			if (player.hornType !== HORNS_SHEEP && player.hornType !== HORNS_RAM && player.earType === Ears.SHEEP && rand(3) === 0 && changes < changeLimit) {
			...
			if (rand(3) === 0 && changes < changeLimit && player.legCount === 2 && player.lowerBody === LOWER_BODY_TYPE_CLOVEN_HOOFED && player.hornType === HORNS_SHEEP && player.tailType === Tail.SHEEP && player.earType === Ears.SHEEP && !player.hasWool()) {
