...
package classes.Items
{
	...
	public final class ArmorLib
	{
		...
		public const BONSTRP:ArmorWithPerk = new ArmorWithPerk("BonStrp","BonStrp","barely-decent bondage straps","a set of bondage straps",0,600,"These leather straps and well-placed hooks are actually designed in such a way as to be worn as clothing.  While they technically would cover your naughty bits, virtually every other inch of your body would be exposed.","Light",
				PerkLib.SluttySeduction,10,0,0,0,"Your fetishy bondage outfit allows you access to an improved form of 'Tease'.",null,0,0,0,0,"", false, false);
		...
		public const EBNARMR:Armor = new ArmorWithPerk("EWPlate", "EWPlate", "Ebonweave Platemail", "a set of Ebonweave Platemail", 27, 3000, "The armor is made of ebonweave, created using refined Ebonbloom petals. The armor consists of two layers: an outer of ebonweave playing and an inner of arrow-proof ebonweave cloth.", "Heavy",
				PerkLib.WizardsEndurance,15,0,0,0);
		public const EBNJACK:Armor = new ArmorWithPerk("EWJacket", "EWJacket", "Ebonweave Jacket", "an Ebonweave Jacket", 18, 3000, "This outfit is made of ebonweave, created using refined Ebonbloom petals. The outfit consists of a leather-like jacket, a mesh breastplate, and a set of arrow-proof clothing.", "Medium",
				PerkLib.WizardsEndurance,15,0,0,0);
		public const EBNROBE:Armor = new ArmorWithPerk("EWRobe", "EWRobe", "Ebonweave Robe", "an Ebonweave Robe", 9, 3000, "This robe is made of ebonweave, a material created using refined Ebonbloom petals. This robe is comfortable, yet more protective than chainmail. It has a mystical aura to it.", "Medium",
				PerkLib.WizardsEndurance,30,0,0,0);
		public const EBNIROB:Armor = new ArmorWithPerk("EWIRobe", "EWIRobe", "Indecent Ebonweave Robe", "an Indecent Ebonweave Robe", 6, 3000, "More of a longcoat than a robe, this outfit is crafted from refined Ebonbloom petals. Discrete straps centered around the belt keep the front open.", "Light",
				PerkLib.WizardsEndurance,30,0,0,0,"",
