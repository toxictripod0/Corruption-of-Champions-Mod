...
package classes.Items
{
	...
	public final class ArmorLib
	{
		...
		public const EBNARMR:Armor = new ArmorWithPerk("EWPlate", "Ebonweave Platemail", "Ebonweave Platemail", "a set of Ebonweave Platemail", 27, 3000, "The armor is made of ebonweave, created using refined Ebonbloom petals. The armor consists of two layers: an outer of ebonweave playing and an inner of arrow-proof ebonweave cloth.", "Heavy",
				PerkLib.WizardsEndurance,15,0,0,0);
		public const EBNJACK:Armor = new ArmorWithPerk("EWJacket", "Ebonweave Jacket", "Ebonweave Jacket", "an Ebonweave Jacket", 18, 3000, "This outfit is made of ebonweave, created using refined Ebonbloom petals. The outfit consists of a leather-like jacket, a mesh breastplate, and a set of arrow-proof clothing.", "Medium",
				PerkLib.WizardsEndurance,15,0,0,0);
