package classes.internals
{
	...
	{
		private static const LOGGER:ILogger = LoggerFactory.getLogger(SaveGameUtils);
		
		private static const SAVE_ROOT_DIRECTORY:String = "/";
		
		public function SaveGameUtils()
		{
		 ...
		 */
		public static function deleteSaveGame(saveName:String):void
		{
		 ...
		 */
		public static function copySaveGame(sourceSaveName:String, destinationSaveName:String):void
		{
