package classes 
{
	...
	public class PlayerAppearance extends BaseContent
	{
		...
		public function appearance():void {
			...
			if (player.faceType == Face.ECHIDNA)
			{
			...
			if (player.faceType == Face.COCKATRICE)
			{
			...
			else if (player.tailType == Tail.IMP) 
			{
			...
			else if (player.tailType == Tail.COCKATRICE) 
			{
